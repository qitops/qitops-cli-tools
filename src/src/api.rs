...
impl ApiTestRunner {
    ...
    async fn validate_response(&self, response: Response, config: &ApiTestConfig, duration: f64) -> Result<()> {
        ...
        let actual_body: serde_json::Value = serde_json::from_str(&body_text)?;
